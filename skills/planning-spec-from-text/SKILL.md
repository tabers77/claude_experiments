---
name: planning-spec-from-text
description: Turn vague business input into a testable spec. Use when converting PM requirements, structuring business cases, or surfacing ambiguity early.
---
