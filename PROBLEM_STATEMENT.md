...
**Solution**: Create an audit skill (`/audit_setup`) that compares your current setup against official documentation and suggests improvements.
...
2. **Stay current**: `/audit_setup` provides actionable suggestions based on latest docs
